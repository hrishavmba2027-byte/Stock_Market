...
5. **Verify Firestore** has 196 docs (49 tickers × 4 quarters) under collection `fundamentals` at <https://console.cloud.google.com/firestore>
...
1. **Firestore writes:** the weekly fundamentals job writes ~200 docs. Even if you misconfigure it to run hourly, that's 200 × 24 = 4,800 writes/day — still under the 20,000/day free limit.
